...
@WebServlet("/issuebooksearch")
public class issuebooksearch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			if(c==0)
			{
				p.println("<marquee behavior=alternate scrollamount=12><h1><i>Required book are not issued to any student</i></h1></marquee>");
			}
			else
			{
				p.println("<marquee behavior=alternate scrollamount=12><h1><i>"+k+" Required books are issued to students</i></h1></marquee>");
